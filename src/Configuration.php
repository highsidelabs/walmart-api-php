...
class Configuration
{
    ...
    /**
     * The signature to use in request headers, when required.
     *
     * @var string
     */
    ...
    /**
     * The consumer ID to use in request headers, when required.
     *
     * @var string
     */
    ...
    public function getAccessToken(): ?AccessToken
    {
        if (!array_key_exists($this->clientId, self::$accessTokens) || self::$accessTokens[$this->clientId]->expired()) {
            $authApi = match ($this->country) {
                Country::US => new MP\US\AuthenticationApi($this),
                Country::MX => new MP\MX\AuthenticationAndAuthorizationApi($this),
                Country::CA => throw new Exception("Canada's Marketplace APIs use signature/consumer ID authentication, not access token authentication."),
            };
    ...
    /**
     * Sets the signature to use in request headers
     *
    ...
    /**
     * Gets the signature to use in request headers
     *
    ...
    {
        $validKeys = ['country', 'accessToken', 'signature', 'consumerId'];
