...
class ReportsApi extends BaseApi
{
     ...
     * @return \Walmart\Models\DSV\US\Reports\ReportDTO
     */
    ...
    protected function getItemReportWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Models\DSV\US\Reports\ReportDTO' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Models\DSV\US\Reports\ReportDTO' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Models\DSV\US\Reports\ReportDTO', $response->getHeaders());
            }
