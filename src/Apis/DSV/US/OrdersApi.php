...
class OrdersApi extends BaseApi
{
     ...
     * @return \Walmart\Models\DSV\US\Orders\GetOrderResponseRecord
     */
    ...
    protected function acknowledgeOrdersWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Models\DSV\US\Orders\GetOrderResponseRecord' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Models\DSV\US\Orders\GetOrderResponseRecord' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Models\DSV\US\Orders\GetOrderResponseRecord', $response->getHeaders());
            }

            $returnType = '\Walmart\Models\DSV\US\Orders\GetOrderResponseRecord';
     ...
     * @param  string $shipNode The Distribution Facility “Distributor ID” which uniquely identifies each facility and is autogenerated during DSV account creation. Every time you add/update a facility in the Supplier Center, a new ID is generated (required)
     * @param  \Walmart\Models\DSV\US\Orders\OrderCancellation $orderCancellation File fields (required)
     *
     * @throws \Walmart\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Walmart\Models\DSV\US\Orders\GetOrderResponseRecord
    ...
    public function cancelOrderLines(
        string $purchaseOrderId,
        string $shipNode,
        \Walmart\Models\DSV\US\Orders\OrderCancellation $orderCancellation
    ): \Walmart\Models\DSV\US\Orders\GetOrderResponseRecord {
