...
class LagTimeApi extends BaseApi
{
     ...
     * @return \Walmart\Model\DSV\US\LagTime\GetLagTime200Response
     */
    public function getLagTime(
        string $shipNode,
        ?string $sku = null,
        ?string $gtin = null
    ): \Walmart\Model\DSV\US\LagTime\GetLagTime200Response {
    ...
    protected function getLagTimeWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Model\DSV\US\LagTime\GetLagTime200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Model\DSV\US\LagTime\GetLagTime200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Model\DSV\US\LagTime\GetLagTime200Response', $response->getHeaders());
            }

            $returnType = '\Walmart\Model\DSV\US\LagTime\GetLagTime200Response';
     ...
     * @param  \Walmart\Model\DSV\US\LagTime\UpdateLagTimeBulkRequest $updateLagTimeBulkRequest File fields (required)
     *
     * @throws \Walmart\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Walmart\Model\DSV\US\LagTime\UpdateLagTimeBulk200Response
     */
    public function updateLagTimeBulk(
        string $feedType,
        string $shipNode,
        \Walmart\Model\DSV\US\LagTime\UpdateLagTimeBulkRequest $updateLagTimeBulkRequest
    ): \Walmart\Model\DSV\US\LagTime\UpdateLagTimeBulk200Response {
    ...
    protected function updateLagTimeBulkWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Model\DSV\US\LagTime\UpdateLagTimeBulk200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Model\DSV\US\LagTime\UpdateLagTimeBulk200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Model\DSV\US\LagTime\UpdateLagTimeBulk200Response', $response->getHeaders());
            }

            $returnType = '\Walmart\Model\DSV\US\LagTime\UpdateLagTimeBulk200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
