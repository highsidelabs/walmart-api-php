...
class LagTimeApi extends BaseApi
{
     ...
     * @return \Walmart\Models\DSV\US\LagTime\LagTimeResponse
     */
    ...
    protected function getLagTimeWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Models\DSV\US\LagTime\LagTimeResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Models\DSV\US\LagTime\LagTimeResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Models\DSV\US\LagTime\LagTimeResponse', $response->getHeaders());
            }

            $returnType = '\Walmart\Models\DSV\US\LagTime\LagTimeResponse';
     ...
     * @param  \Walmart\Models\DSV\US\LagTime\LagTimeFeedV2 $lagTimeFeedV2 File fields (required)
     *
     * @throws \Walmart\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Walmart\Models\DSV\US\LagTime\FeedId
     */
    public function updateLagTimeBulk(
        string $feedType,
        string $shipNode,
        \Walmart\Models\DSV\US\LagTime\LagTimeFeedV2 $lagTimeFeedV2
    ...
    protected function updateLagTimeBulkWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Models\DSV\US\LagTime\FeedId' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Models\DSV\US\LagTime\FeedId' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Models\DSV\US\LagTime\FeedId', $response->getHeaders());
            }

            $returnType = '\Walmart\Models\DSV\US\LagTime\FeedId';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
