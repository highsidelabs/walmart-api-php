...
class InventoryApi extends BaseApi
{
    ...
    protected function updateBulkInventoryRequest(
        ...
        // verify the required parameter 'updateBulkInventoryRequest' is set
        if ($updateBulkInventoryRequest === null || (is_array($updateBulkInventoryRequest) && count($updateBulkInventoryRequest) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $updateBulkInventoryRequest when calling updateBulkInventory'
            );
        }
        ...
        // for model (json/xml)
        if (isset($updateBulkInventoryRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($updateBulkInventoryRequest));
            } else {
                $httpBody = $updateBulkInventoryRequest;
            }
