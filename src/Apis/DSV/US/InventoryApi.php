...
class InventoryApi extends BaseApi
{
     ...
     * @return \Walmart\Models\DSV\US\Inventory\InventoryResponse
     */
    ...
    protected function getInventoryForAnItemWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Models\DSV\US\Inventory\InventoryResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Models\DSV\US\Inventory\InventoryResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Models\DSV\US\Inventory\InventoryResponse', $response->getHeaders());
            }

            $returnType = '\Walmart\Models\DSV\US\Inventory\InventoryResponse';
     ...
     * @throws \Walmart\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Walmart\Models\DSV\US\Inventory\InventoriesDTO
     */
    ...
    protected function getMultiNodeInventoryForSkuAndAllShipnodesWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Models\DSV\US\Inventory\InventoriesDTO' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Models\DSV\US\Inventory\InventoriesDTO' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Models\DSV\US\Inventory\InventoriesDTO', $response->getHeaders());
            }

            $returnType = '\Walmart\Models\DSV\US\Inventory\InventoriesDTO';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @param  \Walmart\Models\DSV\US\Inventory\InventoryFeedV2 $inventoryFeedV2 File fields (required)
     ...
     * @throws \Walmart\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Walmart\Models\DSV\US\Inventory\FeedIdInventory
     */
    public function updateBulkInventory(
        string $feedType,
        \Walmart\Models\DSV\US\Inventory\InventoryFeedV2 $inventoryFeedV2,
        ?string $shipNode = null
    ...
    protected function updateBulkInventoryWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Models\DSV\US\Inventory\FeedIdInventory' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Models\DSV\US\Inventory\FeedIdInventory' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Models\DSV\US\Inventory\FeedIdInventory', $response->getHeaders());
            }

            $returnType = '\Walmart\Models\DSV\US\Inventory\FeedIdInventory';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     *
     * @param  string $shipNode Specifies the distribution facility distributor identifier.    This parameter identifies each facility from which the inventory is requested. The identifier is autogenerated during drop ship vendor (DSV) account creation. Every time users add or update a facility in Supplier Center, a new identifier is generated. (required)
     * @param  \Walmart\Models\DSV\US\Inventory\Inventory $inventory File fields (required)
     *
     * @throws \Walmart\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Walmart\Models\DSV\US\Inventory\InventoryResponse
    ...
    public function updateInventoryForAnItem(
        string $shipNode,
        \Walmart\Models\DSV\US\Inventory\Inventory $inventory
    ): \Walmart\Models\DSV\US\Inventory\InventoryResponse {
