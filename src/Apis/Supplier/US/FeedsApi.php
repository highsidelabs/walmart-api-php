...
class FeedsApi extends BaseApi
{
    ...
    protected function getAllFeedStatusesWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Models\Supplier\US\Feeds\FeedRecordResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Models\Supplier\US\Feeds\FeedRecordResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Models\Supplier\US\Feeds\FeedRecordResponse', $response->getHeaders());
            }
     ...
     * @throws \Walmart\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Walmart\Models\Supplier\US\Feeds\PartnerFeedResponse
     */
    ...
    protected function getFeedItemStatusWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Models\Supplier\US\Feeds\PartnerFeedResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Models\Supplier\US\Feeds\PartnerFeedResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Models\Supplier\US\Feeds\PartnerFeedResponse', $response->getHeaders());
            }
