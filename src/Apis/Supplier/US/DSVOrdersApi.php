...
class DSVOrdersApi extends BaseApi
{
    ...
    public function acknowledgeOrders(
        ...
        return $this->acknowledgeOrdersWithHttpInfo($purchaseOrderId, $shipNode, $accept, $wMPARTNERID);
    }
    ...
    protected function acknowledgeOrdersWithHttpInfo(
        ...
        $request = $this->acknowledgeOrdersRequest($purchaseOrderId, $shipNode, $accept, $wMPARTNERID);
    ...
    public function acknowledgeOrdersAsync(
        ...
        return $this->acknowledgeOrdersAsyncWithHttpInfo($purchaseOrderId, $shipNode, $accept, $wMPARTNERID)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    protected function acknowledgeOrdersRequest(
        ...
        if ($accept === null || (is_array($accept) && count($accept) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $accept when calling acknowledgeOrders'
            );
        }
        // verify the required parameter 'wMPARTNERID' is set
        if ($wMPARTNERID === null || (is_array($wMPARTNERID) && count($wMPARTNERID) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $wMPARTNERID when calling acknowledgeOrders'
            );
        }
    ...
    public function cancelOrderLines(
        ...
        return $this->cancelOrderLinesWithHttpInfo($purchaseOrderId, $shipNode, $accept, $wMPARTNERID, $orderCancellation);
    }
    ...
    protected function cancelOrderLinesWithHttpInfo(
        ...
        $request = $this->cancelOrderLinesRequest($purchaseOrderId, $shipNode, $accept, $wMPARTNERID, $orderCancellation);
        $this->writeDebug($request);
        $this->writeDebug((string) $request->getBody());
    ...
    public function cancelOrderLinesAsync(
        ...
        return $this->cancelOrderLinesAsyncWithHttpInfo($purchaseOrderId, $shipNode, $accept, $wMPARTNERID, $orderCancellation)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    protected function cancelOrderLinesRequest(
        ...
        if ($accept === null || (is_array($accept) && count($accept) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $accept when calling cancelOrderLines'
            );
        }
        // verify the required parameter 'wMPARTNERID' is set
        if ($wMPARTNERID === null || (is_array($wMPARTNERID) && count($wMPARTNERID) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $wMPARTNERID when calling cancelOrderLines'
            );
        }
    ...
    public function getAllOrders(
        ...
        return $this->getAllOrdersWithHttpInfo($shipNode, $accept, $wMPARTNERID, $limit, $sku, $customerOrderId, $purchaseOrderId, $status, $createdStartDate, $createdEndDate, $fromExpectedShipDate, $toExpectedShipDate, $productInfo);
    }
    ...
    protected function getAllOrdersWithHttpInfo(
        ...
        $request = $this->getAllOrdersRequest($shipNode, $accept, $wMPARTNERID, $limit, $sku, $customerOrderId, $purchaseOrderId, $status, $createdStartDate, $createdEndDate, $fromExpectedShipDate, $toExpectedShipDate, $productInfo);
        $this->writeDebug($request);
        $this->writeDebug((string) $request->getBody());
    ...
    public function getAllOrdersAsync(
        ...
        return $this->getAllOrdersAsyncWithHttpInfo($shipNode, $accept, $wMPARTNERID, $limit, $sku, $customerOrderId, $purchaseOrderId, $status, $createdStartDate, $createdEndDate, $fromExpectedShipDate, $toExpectedShipDate, $productInfo)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    protected function getAllOrdersRequest(
        ...
        if ($wMPARTNERID === null || (is_array($wMPARTNERID) && count($wMPARTNERID) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $wMPARTNERID when calling getAllOrders'
            );
        }
    ...
    public function getAllReleasedOrders(
        ...
        return $this->getAllReleasedOrdersWithHttpInfo($shipNode, $accept, $wMPARTNERID, $sku, $customerOrderId, $purchaseOrderId, $createdStartDate, $createdEndDate, $fromExpectedShipDate, $toExpectedShipDate, $limit, $productInfo);
    }
    ...
    protected function getAllReleasedOrdersWithHttpInfo(
        ...
        $request = $this->getAllReleasedOrdersRequest($shipNode, $accept, $wMPARTNERID, $sku, $customerOrderId, $purchaseOrderId, $createdStartDate, $createdEndDate, $fromExpectedShipDate, $toExpectedShipDate, $limit, $productInfo);
        $this->writeDebug($request);
        $this->writeDebug((string) $request->getBody());
    ...
    public function getAllReleasedOrdersAsync(
        ...
        return $this->getAllReleasedOrdersAsyncWithHttpInfo($shipNode, $accept, $wMPARTNERID, $sku, $customerOrderId, $purchaseOrderId, $createdStartDate, $createdEndDate, $fromExpectedShipDate, $toExpectedShipDate, $limit, $productInfo)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    protected function getAllReleasedOrdersRequest(
        ...
        if ($accept === null || (is_array($accept) && count($accept) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $accept when calling getAllReleasedOrders'
            );
        }
        // verify the required parameter 'wMPARTNERID' is set
        if ($wMPARTNERID === null || (is_array($wMPARTNERID) && count($wMPARTNERID) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $wMPARTNERID when calling getAllReleasedOrders'
            );
        }
    ...
    public function getAnOrder(
        ...
        return $this->getAnOrderWithHttpInfo($purchaseOrderId, $shipNode, $accept, $wMPARTNERID, $productInfo);
    }
    ...
    protected function getAnOrderWithHttpInfo(
        ...
        $request = $this->getAnOrderRequest($purchaseOrderId, $shipNode, $accept, $wMPARTNERID, $productInfo);
        $this->writeDebug($request);
        $this->writeDebug((string) $request->getBody());
    ...
    public function getAnOrderAsync(
        ...
        return $this->getAnOrderAsyncWithHttpInfo($purchaseOrderId, $shipNode, $accept, $wMPARTNERID, $productInfo)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    protected function getAnOrderRequest(
        ...
        if ($wMPARTNERID === null || (is_array($wMPARTNERID) && count($wMPARTNERID) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $wMPARTNERID when calling getAnOrder'
            );
        }
    ...
    public function shipOrderLines(
        ...
        return $this->shipOrderLinesWithHttpInfo($purchaseOrderId, $shipNode, $accept, $wMPARTNERID, $orderCancellation);
    }
    ...
    protected function shipOrderLinesWithHttpInfo(
        ...
        $request = $this->shipOrderLinesRequest($purchaseOrderId, $shipNode, $accept, $wMPARTNERID, $orderCancellation);
        $this->writeDebug($request);
        $this->writeDebug((string) $request->getBody());
    ...
    public function shipOrderLinesAsync(
        ...
        return $this->shipOrderLinesAsyncWithHttpInfo($purchaseOrderId, $shipNode, $accept, $wMPARTNERID, $orderCancellation)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    protected function shipOrderLinesRequest(
        ...
        if ($accept === null || (is_array($accept) && count($accept) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $accept when calling shipOrderLines'
            );
        }
        // verify the required parameter 'wMPARTNERID' is set
        if ($wMPARTNERID === null || (is_array($wMPARTNERID) && count($wMPARTNERID) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $wMPARTNERID when calling shipOrderLines'
            );
        }
        // verify the required parameter 'orderCancellation' is set
        if ($orderCancellation === null || (is_array($orderCancellation) && count($orderCancellation) === 0)) {
