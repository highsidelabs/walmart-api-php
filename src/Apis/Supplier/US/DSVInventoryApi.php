...
class DSVInventoryApi extends BaseApi
{
    ...
    public function getInventoryForAnItem(
        ...
        return $this->getInventoryForAnItemWithHttpInfo($gtin, $shipNode, $accept, $wMPARTNERID, $sku);
    }
    ...
    protected function getInventoryForAnItemWithHttpInfo(
        ...
        $request = $this->getInventoryForAnItemRequest($gtin, $shipNode, $accept, $wMPARTNERID, $sku);
    ...
    public function getInventoryForAnItemAsync(
        ...
        return $this->getInventoryForAnItemAsyncWithHttpInfo($gtin, $shipNode, $accept, $wMPARTNERID, $sku)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    protected function getInventoryForAnItemRequest(
        ...
        if ($accept === null || (is_array($accept) && count($accept) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $accept when calling getInventoryForAnItem'
            );
        }
        // verify the required parameter 'wMPARTNERID' is set
        if ($wMPARTNERID === null || (is_array($wMPARTNERID) && count($wMPARTNERID) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $wMPARTNERID when calling getInventoryForAnItem'
            );
        }
    ...
    public function getMultiNodeInventoryForSkuAndAllShipnodes(
        ...
        return $this->getMultiNodeInventoryForSkuAndAllShipnodesWithHttpInfo($id, $productIdType, $accept, $wMPARTNERID, $shipNode);
    }
    ...
    protected function getMultiNodeInventoryForSkuAndAllShipnodesWithHttpInfo(
        ...
        $request = $this->getMultiNodeInventoryForSkuAndAllShipnodesRequest($id, $productIdType, $accept, $wMPARTNERID, $shipNode);
        $this->writeDebug($request);
        $this->writeDebug((string) $request->getBody());
    ...
    public function getMultiNodeInventoryForSkuAndAllShipnodesAsync(
        ...
        return $this->getMultiNodeInventoryForSkuAndAllShipnodesAsyncWithHttpInfo($id, $productIdType, $accept, $wMPARTNERID, $shipNode)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    protected function getMultiNodeInventoryForSkuAndAllShipnodesRequest(
        ...
        if ($accept === null || (is_array($accept) && count($accept) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $accept when calling getMultiNodeInventoryForSkuAndAllShipnodes'
            );
        }
        // verify the required parameter 'wMPARTNERID' is set
        if ($wMPARTNERID === null || (is_array($wMPARTNERID) && count($wMPARTNERID) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $wMPARTNERID when calling getMultiNodeInventoryForSkuAndAllShipnodes'
            );
        }
    ...
    public function updateBulkInventory(
        ...
        return $this->updateBulkInventoryWithHttpInfo($feedType, $accept, $wMPARTNERID, $inventoryFeedV2, $shipNode);
    }
    ...
    protected function updateBulkInventoryWithHttpInfo(
        ...
        $request = $this->updateBulkInventoryRequest($feedType, $accept, $wMPARTNERID, $inventoryFeedV2, $shipNode);
        $this->writeDebug($request);
        $this->writeDebug((string) $request->getBody());
    ...
    public function updateBulkInventoryAsync(
        ...
        return $this->updateBulkInventoryAsyncWithHttpInfo($feedType, $accept, $wMPARTNERID, $inventoryFeedV2, $shipNode)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    protected function updateBulkInventoryRequest(
        ...
        if ($accept === null || (is_array($accept) && count($accept) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $accept when calling updateBulkInventory'
            );
        }
        // verify the required parameter 'wMPARTNERID' is set
        if ($wMPARTNERID === null || (is_array($wMPARTNERID) && count($wMPARTNERID) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $wMPARTNERID when calling updateBulkInventory'
            );
        }
    ...
    public function updateInventoryForAnItem(
        ...
        return $this->updateInventoryForAnItemWithHttpInfo($shipNode, $accept, $wMPARTNERID, $inventory);
    }
    ...
    protected function updateInventoryForAnItemWithHttpInfo(
        ...
        $request = $this->updateInventoryForAnItemRequest($shipNode, $accept, $wMPARTNERID, $inventory);
        $this->writeDebug($request);
        $this->writeDebug((string) $request->getBody());
    ...
    public function updateInventoryForAnItemAsync(
        ...
        return $this->updateInventoryForAnItemAsyncWithHttpInfo($shipNode, $accept, $wMPARTNERID, $inventory)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    protected function updateInventoryForAnItemRequest(
        ...
        if ($accept === null || (is_array($accept) && count($accept) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $accept when calling updateInventoryForAnItem'
            );
        }
        // verify the required parameter 'wMPARTNERID' is set
        if ($wMPARTNERID === null || (is_array($wMPARTNERID) && count($wMPARTNERID) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $wMPARTNERID when calling updateInventoryForAnItem'
            );
        }
