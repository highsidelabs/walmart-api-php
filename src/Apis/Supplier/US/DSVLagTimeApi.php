...
class DSVLagTimeApi extends BaseApi
{
    ...
    public function getLagTime(
        ...
        return $this->getLagTimeWithHttpInfo($shipNode, $accept, $wMPARTNERID, $sku, $gtin);
    }
    ...
    protected function getLagTimeWithHttpInfo(
        ...
        $request = $this->getLagTimeRequest($shipNode, $accept, $wMPARTNERID, $sku, $gtin);
    ...
    public function getLagTimeAsync(
        ...
        return $this->getLagTimeAsyncWithHttpInfo($shipNode, $accept, $wMPARTNERID, $sku, $gtin)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    protected function getLagTimeRequest(
        ...
        if ($accept === null || (is_array($accept) && count($accept) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $accept when calling getLagTime'
            );
        }
        // verify the required parameter 'wMPARTNERID' is set
        if ($wMPARTNERID === null || (is_array($wMPARTNERID) && count($wMPARTNERID) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $wMPARTNERID when calling getLagTime'
            );
        }
    ...
    public function updateLagTimeBulk(
        ...
        return $this->updateLagTimeBulkWithHttpInfo($feedType, $shipNode, $accept, $wMPARTNERID, $lagTimeFeedV2);
    }
    ...
    protected function updateLagTimeBulkWithHttpInfo(
        ...
        $request = $this->updateLagTimeBulkRequest($feedType, $shipNode, $accept, $wMPARTNERID, $lagTimeFeedV2);
        $this->writeDebug($request);
        $this->writeDebug((string) $request->getBody());
    ...
    public function updateLagTimeBulkAsync(
        ...
        return $this->updateLagTimeBulkAsyncWithHttpInfo($feedType, $shipNode, $accept, $wMPARTNERID, $lagTimeFeedV2)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    protected function updateLagTimeBulkRequest(
        ...
        if ($accept === null || (is_array($accept) && count($accept) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $accept when calling updateLagTimeBulk'
            );
        }
        // verify the required parameter 'wMPARTNERID' is set
        if ($wMPARTNERID === null || (is_array($wMPARTNERID) && count($wMPARTNERID) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $wMPARTNERID when calling updateLagTimeBulk'
            );
        }
