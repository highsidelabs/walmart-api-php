...
class ItemsApi extends BaseApi
{
    ...
    public const contentTypes = [
        'bulkItemSetup' => 'multipart/form-data',
     ...
     * @return \Walmart\Model\MP\MX\Items\BulkItemSetup200Response
     */
    public function bulkItemSetup(
        string $feedType,
        \SplFileObject $file
    ): \Walmart\Model\MP\MX\Items\BulkItemSetup200Response {
        return $this->bulkItemSetupWithHttpInfo($feedType, $file);
    }

    /**
     * Operation bulkItemSetupWithHttpInfo
     *
     * Bulk Item Setup
     *
     * @param  string $feedType The feed Type (required)
    ...
    protected function bulkItemSetupWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Model\MP\MX\Items\BulkItemSetup200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Model\MP\MX\Items\BulkItemSetup200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Model\MP\MX\Items\BulkItemSetup200Response', $response->getHeaders());
            }

            $returnType = '\Walmart\Model\MP\MX\Items\BulkItemSetup200Response';
     ...
     */
    public function bulkItemSetupAsync(
        string $feedType,
        \SplFileObject $file
    ): PromiseInterface {
        return $this->bulkItemSetupAsyncWithHttpInfo($feedType, $file)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Create request for operation 'bulkItemSetup'
     *
     * @param  string $feedType The feed Type (required)
     * @param  \SplFileObject $file Feed file to upload (required)
     *
    ...
    protected function bulkItemSetupRequest(
        ...
        if ($feedType === null || (is_array($feedType) && count($feedType) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $feedType when calling bulkItemSetup'
            );
        }
        // verify the required parameter 'file' is set
        if ($file === null || (is_array($file) && count($file) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $file when calling bulkItemSetup'
            );
        }
     ...
     * @throws \Walmart\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Walmart\Model\MP\MX\Items\GetAllItems200Response
     */
    public function getAllItems(
        ...
        ?string $offset = '0',
        ?string $limit = '20'
    ): \Walmart\Model\MP\MX\Items\GetAllItems200Response {
    ...
    protected function getAllItemsWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Model\MP\MX\Items\GetAllItems200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Model\MP\MX\Items\GetAllItems200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Model\MP\MX\Items\GetAllItems200Response', $response->getHeaders());
            }

            $returnType = '\Walmart\Model\MP\MX\Items\GetAllItems200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @throws \Walmart\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Walmart\Model\MP\MX\Items\GetAnItem200Response
     */
    public function getAnItem(
        string $sku
    ): \Walmart\Model\MP\MX\Items\GetAnItem200Response {
    ...
    protected function getAnItemWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Model\MP\MX\Items\GetAnItem200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Model\MP\MX\Items\GetAnItem200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Model\MP\MX\Items\GetAnItem200Response', $response->getHeaders());
            }

            $returnType = '\Walmart\Model\MP\MX\Items\GetAnItem200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @throws \Walmart\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Walmart\Model\MP\MX\Items\RetireAnItem200Response
     */
    public function retireAnItem(
        string $sKU
    ): \Walmart\Model\MP\MX\Items\RetireAnItem200Response {
    ...
    protected function retireAnItemWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Model\MP\MX\Items\RetireAnItem200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Model\MP\MX\Items\RetireAnItem200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Model\MP\MX\Items\RetireAnItem200Response', $response->getHeaders());
            }

            $returnType = '\Walmart\Model\MP\MX\Items\RetireAnItem200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
