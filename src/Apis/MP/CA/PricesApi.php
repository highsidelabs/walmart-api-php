...
class PricesApi extends BaseApi
{
     ...
     * @return \Walmart\Models\MP\CA\Prices\FeedId
     */
    ...
    protected function priceBulkUploadsWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Models\MP\CA\Prices\FeedId' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Models\MP\CA\Prices\FeedId' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Models\MP\CA\Prices\FeedId', $response->getHeaders());
            }

            $returnType = '\Walmart\Models\MP\CA\Prices\FeedId';
     ...
     * @throws \Walmart\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Walmart\Models\MP\CA\Prices\MPItemPriceResponseV2
     */
    ...
    protected function updatePriceCAWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Models\MP\CA\Prices\MPItemPriceResponseV2' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Models\MP\CA\Prices\MPItemPriceResponseV2' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Models\MP\CA\Prices\MPItemPriceResponseV2', $response->getHeaders());
            }

            $returnType = '\Walmart\Models\MP\CA\Prices\MPItemPriceResponseV2';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
