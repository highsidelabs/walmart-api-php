...
class FeedsApi extends BaseApi
{
     ...
     * @return \Walmart\Models\MP\CA\Feeds\BulkContentSetup200Response
     */
    public function bulkContentSetup(
        string $feedType,
        \SplFileObject $file
    ): \Walmart\Models\MP\CA\Feeds\BulkContentSetup200Response {
        return $this->bulkContentSetupWithHttpInfo($feedType, $file);
    }

    /**
     * Operation bulkContentSetupWithHttpInfo
     *
     * Content feeds
     *
     * @param  string $feedType The feed Type (required)
    ...
    protected function bulkContentSetupWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Models\MP\CA\Feeds\BulkContentSetup200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Models\MP\CA\Feeds\BulkContentSetup200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Models\MP\CA\Feeds\BulkContentSetup200Response', $response->getHeaders());
            }

            $returnType = '\Walmart\Models\MP\CA\Feeds\BulkContentSetup200Response';
    ...
    /**
     * Operation bulkContentSetupAsync
     *
     * Content feeds
     *
     * @param  string $feedType The feed Type (required)
     ...
     */
    public function bulkContentSetupAsync(
        string $feedType,
        \SplFileObject $file
    ): PromiseInterface {
        return $this->bulkContentSetupAsyncWithHttpInfo($feedType, $file)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation bulkContentSetupAsyncWithHttpInfo
     *
     *
     * Content feeds
     *
    ...
    /**
     * Create request for operation 'bulkContentSetup'
     *
     * @param  string $feedType The feed Type (required)
     * @param  \SplFileObject $file Feed file to upload (required)
     *
    ...
    protected function bulkContentSetupRequest(
        ...
        if ($feedType === null || (is_array($feedType) && count($feedType) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $feedType when calling bulkContentSetup'
            );
        }
        // verify the required parameter 'file' is set
        if ($file === null || (is_array($file) && count($file) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $file when calling bulkContentSetup'
            );
        }
     ...
     * @throws \Walmart\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Walmart\Models\MP\CA\Feeds\GetAllFeedStatuses200Response
     */
    ...
    protected function getAllFeedStatusesWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Models\MP\CA\Feeds\GetAllFeedStatuses200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Models\MP\CA\Feeds\GetAllFeedStatuses200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Models\MP\CA\Feeds\GetAllFeedStatuses200Response', $response->getHeaders());
            }

            $returnType = '\Walmart\Models\MP\CA\Feeds\GetAllFeedStatuses200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @throws \Walmart\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Walmart\Models\MP\CA\Feeds\GetFeedItemStatus200Response
     */
    ...
    protected function getFeedItemStatusWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Models\MP\CA\Feeds\GetFeedItemStatus200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Models\MP\CA\Feeds\GetFeedItemStatus200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Models\MP\CA\Feeds\GetFeedItemStatus200Response', $response->getHeaders());
            }

            $returnType = '\Walmart\Models\MP\CA\Feeds\GetFeedItemStatus200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
    ...
    protected function getFeedItemStatusRequest(
        ...
        $resourcePath = '/v3/ca/feeds/{feedId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
