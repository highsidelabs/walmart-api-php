...
/**
 * GetAllOrders200ResponseOrderInnerOrderLinesInnerChargesInner
 *
 * PHP version 7.4
 *
 * @category Class
 ...
 * @email    jesse@highsidelabs.co
 */
class GetAllOrders200ResponseOrderInnerOrderLinesInnerChargesInner extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'getAllOrders_200_response_order_inner_orderLines_inner_charges_inner';
     ...
     * Sets chargeType
     *
     * @param string|null $chargeType chargeType
     *
     * @return self
     ...
     * Sets chargeName
     *
     * @param string|null $chargeName chargeName
     *
     * @return self
