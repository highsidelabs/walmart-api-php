...
/**
 * CancelOrderLinesRequestOrderCancellationOrderLinesOrderLineInnerOrderLineStatusesOrderLineStatusInner Class Doc Comment
 *
 * @category Class
 ...
 * @email    jesse@highsidelabs.co
 */
class CancelOrderLinesRequestOrderCancellationOrderLinesOrderLineInnerOrderLineStatusesOrderLineStatusInner extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'cancelOrderLines_request_orderCancellation_orderLines_orderLine_inner_orderLineStatuses_orderLineStatus_inner';
    ...
    public const CANCELLATION_REASON_SELLER_CANCEL_PRICING_ERROR = 'SELLER_CANCEL_PRICING_ERROR';

    public const CANCELLATION_REASON_SELLER_CANCEL_OUT_OF_STOCK = 'SELLER_CANCEL_OUT_OF_STOCK';

    public const CANCELLATION_REASON_SELLER_CANCEL_FRAUD_STOP_SHIPMENT = 'SELLER_CANCEL_FRAUD_STOP_SHIPMENT';

    public const CANCELLATION_REASON_SELLER_CANCEL_ADDRESS_NOT_SERVICEABLE = 'SELLER_CANCEL_ADDRESS_NOT_SERVICEABLE';
    ...
    public function getCancellationReasonAllowableValues()
    {
        return [
            ...
            self::CANCELLATION_REASON_SELLER_CANCEL_PRICING_ERROR,
            self::CANCELLATION_REASON_SELLER_CANCEL_OUT_OF_STOCK,
            self::CANCELLATION_REASON_SELLER_CANCEL_FRAUD_STOP_SHIPMENT,
            self::CANCELLATION_REASON_SELLER_CANCEL_ADDRESS_NOT_SERVICEABLE,
        ];
    }
     ...
     *
     * @param string $cancellationReason Reason for cancellation. Example: 'CUSTOMER_REQUESTED_SELLER_TO_CANCEL'.  Cancellation reason should not be \"CUSTOMER_REQUESTED_SELLER_TO_CANCEL\" for non intent to cancel orders'
     *
     * @return self
