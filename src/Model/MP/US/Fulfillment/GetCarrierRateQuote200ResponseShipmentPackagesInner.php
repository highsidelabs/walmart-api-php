...
/**
 * GetCarrierRateQuote200ResponseShipmentPackagesInner
 *
 * PHP version 7.4
 *
 * @category Class
 ...
 * @email    jesse@highsidelabs.co
 */
class GetCarrierRateQuote200ResponseShipmentPackagesInner extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'getCarrierRateQuote_200_response_shipmentPackages_inner';
    ...
    public function setWeight($weight)
    {
        ...
        if (($weight < -1)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling GetCarrierRateQuote200ResponseShipmentPackagesInner., must be bigger than or equal to -1.');
        }
    ...
    public function setLength($length)
    {
        ...
        if (($length < -1)) {
            throw new \InvalidArgumentException('invalid value for $length when calling GetCarrierRateQuote200ResponseShipmentPackagesInner., must be bigger than or equal to -1.');
        }
    ...
    public function setHeight($height)
    {
        ...
        if (($height < -1)) {
            throw new \InvalidArgumentException('invalid value for $height when calling GetCarrierRateQuote200ResponseShipmentPackagesInner., must be bigger than or equal to -1.');
        }
    ...
    public function setWidth($width)
    {
        ...
        if (($width < -1)) {
            throw new \InvalidArgumentException('invalid value for $width when calling GetCarrierRateQuote200ResponseShipmentPackagesInner., must be bigger than or equal to -1.');
        }
