...
/**
 * UpdateShipmentQuantityRequest Class Doc Comment
 *
 * @category Class
 ...
 * @email    jesse@highsidelabs.co
 */
class UpdateShipmentQuantityRequest extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'updateShipmentQuantity_request';
    ...
    protected static array $openAPITypes = [
        ...
        'shipmentId' => 'string',
        'orderItems' => '\Walmart\Model\MP\US\Fulfillment\UpdateShipmentQuantityRequestOrderItemsInner[]'
    ];
     ...
     * Gets orderItems
     *
     * @return \Walmart\Model\MP\US\Fulfillment\UpdateShipmentQuantityRequestOrderItemsInner[]|null
     ...
     * Sets orderItems
     *
     * @param \Walmart\Model\MP\US\Fulfillment\UpdateShipmentQuantityRequestOrderItemsInner[]|null $orderItems update shipment qty line items
     *
     * @return self
    ...
    public function setOrderItems($orderItems)
    {
        ...
        if ((count($orderItems) > 5000)) {
            throw new \InvalidArgumentException('invalid value for $orderItems when calling UpdateShipmentQuantityRequest., number of items must be less than or equal to 5000.');
        }
        if ((count($orderItems) < 1)) {
            throw new \InvalidArgumentException('invalid length for $orderItems when calling UpdateShipmentQuantityRequest., number of items must be greater than or equal to 1.');
        }
