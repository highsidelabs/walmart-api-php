...
/**
 * PromiseFulfillments200ResponsePayloadOffersInnerAvailableQuantity
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PromiseFulfillments200ResponsePayloadOffersInnerAvailableQuantity Class Doc Comment
 *
 * @category Class
 ...
 * @email    jesse@highsidelabs.co
 */
class PromiseFulfillments200ResponsePayloadOffersInnerAvailableQuantity extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'promiseFulfillments_200_response_payload_offers_inner_availableQuantity';
    ...
    public function setMeasurementValue($measurementValue)
    {
        ...
        if (($measurementValue < 1)) {
            throw new \InvalidArgumentException('invalid value for $measurementValue when calling PromiseFulfillments200ResponsePayloadOffersInnerAvailableQuantity., must be bigger than or equal to 1.');
        }
