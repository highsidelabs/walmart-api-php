 ...
 * @email    jesse@highsidelabs.co
 */
class GetMultiNodeInventoryForAllSkuAndAllShipNodes200ResponseMeta extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'getMultiNodeInventoryForAllSkuAndAllShipNodes_200_response_meta';
