...
/**
 * FeedRecordResponseResultsInner Class Doc Comment
 *
 * @category Class
 ...
 * @email    jesse@highsidelabs.co
 */
class FeedRecordResponseResultsInner extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'FeedRecordResponse_results_inner';
