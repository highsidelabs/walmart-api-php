...
/**
 * IngestionErrorsIngestionErrorInner Class Doc Comment
 *
 * @category Class
 ...
 * @email    jesse@highsidelabs.co
 */
class IngestionErrorsIngestionErrorInner extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'IngestionErrors_ingestionError_inner';
