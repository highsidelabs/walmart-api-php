...
/**
 * ItemDetailsItemIngestionStatusInner Class Doc Comment
 *
 * @category Class
 ...
 * @email    jesse@highsidelabs.co
 */
class ItemDetailsItemIngestionStatusInner extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ItemDetails_itemIngestionStatus_inner';
