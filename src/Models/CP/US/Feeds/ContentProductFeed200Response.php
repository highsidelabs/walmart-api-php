 ...
 * @email    jesse@highsidelabs.co
 */
class ContentProductFeed200Response extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'contentProductFeed_200_response';
