...
/**
 * UpdateBulkInventoryRequestInventoryFeedHeader
 *
 * PHP version 7.4
 *
 * @category Class
 ...
 * @email    jesse@highsidelabs.co
 */
class UpdateBulkInventoryRequestInventoryFeedHeader extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'updateBulkInventory_request_inventoryFeedHeader';
     ...
     * Sets version
     *
     * @param string $version Specifies the inventory feed header version.
     *
     * @return self
     ...
     * Sets feedType
     *
     * @param string $feedType Specifies the feed type for inventory feed header information.   Feed types include:  `DSV_INVENTORY`
     *
     * @return self
     ...
     * Sets feedDate
     *
     * @param string $feedDate Specifies the inventory feed header feed date.
     *
     * @return self
     ...
     * Sets locale
     *
     * @param string $locale Specifies the inventory feed header locale.
     *
     * @return self
     ...
     * Sets businessUnit
     *
     * @param string $businessUnit Specifies the inventory feed header business unit.
     *
     * @return self
