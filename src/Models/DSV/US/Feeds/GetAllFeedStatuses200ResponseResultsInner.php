...
/**
 * GetAllFeedStatuses200ResponseResultsInner
 *
 * PHP version 7.4
 *
 * @category Class
 ...
 * @email    jesse@highsidelabs.co
 */
class GetAllFeedStatuses200ResponseResultsInner extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'getAllFeedStatuses_200_response_results_inner';
     ...
     * Sets feedDate
     *
     * @param \DateTime|null $feedDate The date and time the feed was submitted. Format: yyyymmddThh:mm:ss.xxxz
     *
     * @return self
     ...
     * Sets modifiedDtm
     *
     * @param \DateTime|null $modifiedDtm The most recent time the feed was modified. Format: yyyymmddThh:mm:ss.xxxz
     *
     * @return self
