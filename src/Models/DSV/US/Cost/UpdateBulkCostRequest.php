...
/**
 * UpdateBulkCostRequest Class Doc Comment
 *
 * @category Class
 ...
 * @email    jesse@highsidelabs.co
 */
class UpdateBulkCostRequest extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'updateBulkCost_request';
