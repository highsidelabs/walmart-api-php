 ...
 * @email    jesse@highsidelabs.co
 */
class GetRequestsStatus200ResponseRequestsInnerPayload extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'getRequestsStatus_200_response_requests_inner_payload';
