...
/**
 * DownloadReport200Response Class Doc Comment
 *
 * @category Class
 ...
 * @email    jesse@highsidelabs.co
 */
class DownloadReport200Response extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'downloadReport_200_response';
    ...
    protected static array $openAPIFormats = [
        'downloadURL' => null,
        'downloadURLExpirationTime' => null,
        'requestId' => 'uuid',
        'requestStatus' => null,
    ...
    protected static array $openAPINullables = [
        'downloadURL' => false,
        'downloadURLExpirationTime' => false,
        'requestId' => false,
        'requestStatus' => false,
    ...
    protected static array $attributeMap = [
        ...
        'downloadURLExpirationTime' => 'downloadURLExpirationTime',
        'requestId' => 'requestId',
    ...
    protected static array $setters = [
        ...
        'downloadURLExpirationTime' => 'setDownloadURLExpirationTime',
    ...
    protected static array $getters = [
        ...
        'downloadURLExpirationTime' => 'getDownloadURLExpirationTime',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('downloadURLExpirationTime', $data ?? [], null);
     ...
     * Sets downloadURL
     *
     * @param string|null $downloadURL URL to be used to download the report.
     *
     * @return self
    ...
    /**
     * Gets downloadURLExpirationTime
     *
     * @return string|null
    
     */
    public function getDownloadURLExpirationTime()
    {
        return $this->container['downloadURLExpirationTime'];
    }

    /**
     * Sets downloadURLExpirationTime
     *
     * @param string|null $downloadURLExpirationTime Time till when the URL to download the report will be valid.
     *
     * @return self
    
     */
    public function setDownloadURLExpirationTime($downloadURLExpirationTime)
    {
        if (is_null($downloadURLExpirationTime)) {
            throw new \InvalidArgumentException('non-nullable downloadURLExpirationTime cannot be null');
        }

        $this->container['downloadURLExpirationTime'] = $downloadURLExpirationTime;
        return $this;
    }
