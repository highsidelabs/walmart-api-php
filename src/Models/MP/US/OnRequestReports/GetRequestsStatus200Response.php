 ...
 * @email    jesse@highsidelabs.co
 */
class GetRequestsStatus200Response extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'getRequestsStatus_200_response';
