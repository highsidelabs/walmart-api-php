...
/**
 * MultiNodeInventoryUpdateRequestDTO Class Doc Comment
 *
 * @category Class
 ...
 * @email    jesse@highsidelabs.co
 */
class MultiNodeInventoryUpdateRequestDTO extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'MultiNodeInventoryUpdateRequestDTO';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['inventories'] === null) {
            $invalidProperties[] = "'inventories' can't be null";
        }
