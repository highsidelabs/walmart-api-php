...
/**
 * ShippingUpdates200ResponseOrderShippingInfoPostalAddress
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ShippingUpdates200ResponseOrderShippingInfoPostalAddress Class Doc Comment
 *
 * @category Class
 ...
 * @email    jesse@highsidelabs.co
 */
class ShippingUpdates200ResponseOrderShippingInfoPostalAddress extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'shippingUpdates_200_response_order_shippingInfo_postalAddress';
     ...
     * Sets name
     *
     * @param string $name The name for the person/place of shipping address
     *
     * @return self
