...
/**
 * ItemPriceTypePricingListPricingInnerCurrentPrice
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ItemPriceTypePricingListPricingInnerCurrentPrice Class Doc Comment
 *
 * @category Class
 ...
 * @email    jesse@highsidelabs.co
 */
class ItemPriceTypePricingListPricingInnerCurrentPrice extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ItemPriceType_pricingList_pricing_inner_currentPrice';
    ...
    protected static array $openAPITypes = [
        'value' => '\Walmart\Models\MP\US\Promotions\ItemPriceTypePricingListPricingInnerCurrentPriceValue',
        'uomType' => 'string',
        'minValue' => '\Walmart\Models\MP\US\Promotions\ItemPriceTypePricingListPricingInnerCurrentPriceValue',
        'maxValue' => '\Walmart\Models\MP\US\Promotions\ItemPriceTypePricingListPricingInnerCurrentPriceValue',
        'perUnitValue' => '\Walmart\Models\MP\US\Promotions\ItemPriceTypePricingListPricingInnerCurrentPriceValue',
        'minUnitValue' => '\Walmart\Models\MP\US\Promotions\ItemPriceTypePricingListPricingInnerCurrentPriceValue',
        'maxUnitValue' => '\Walmart\Models\MP\US\Promotions\ItemPriceTypePricingListPricingInnerCurrentPriceValue'
    ];
     ...
     * Sets value
     *
     * @param \Walmart\Models\MP\US\Promotions\ItemPriceTypePricingListPricingInnerCurrentPriceValue|null $value value
     *
     * @return self
     ...
     * Sets minValue
     *
     * @param \Walmart\Models\MP\US\Promotions\ItemPriceTypePricingListPricingInnerCurrentPriceValue|null $minValue minValue
     *
     * @return self
     ...
     * Sets maxValue
     *
     * @param \Walmart\Models\MP\US\Promotions\ItemPriceTypePricingListPricingInnerCurrentPriceValue|null $maxValue maxValue
     *
     * @return self
     ...
     * Sets perUnitValue
     *
     * @param \Walmart\Models\MP\US\Promotions\ItemPriceTypePricingListPricingInnerCurrentPriceValue|null $perUnitValue perUnitValue
     *
     * @return self
     ...
     * Sets minUnitValue
     *
     * @param \Walmart\Models\MP\US\Promotions\ItemPriceTypePricingListPricingInnerCurrentPriceValue|null $minUnitValue minUnitValue
     *
     * @return self
     ...
     * Sets maxUnitValue
     *
     * @param \Walmart\Models\MP\US\Promotions\ItemPriceTypePricingListPricingInnerCurrentPriceValue|null $maxUnitValue maxUnitValue
     *
     * @return self
