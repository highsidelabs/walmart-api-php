...
/**
 * ResponseItemErrorsInner Class Doc Comment
 *
 * @category Class
 ...
 * @email    jesse@highsidelabs.co
 */
class ResponseItemErrorsInner extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ResponseItem_errors_inner';
