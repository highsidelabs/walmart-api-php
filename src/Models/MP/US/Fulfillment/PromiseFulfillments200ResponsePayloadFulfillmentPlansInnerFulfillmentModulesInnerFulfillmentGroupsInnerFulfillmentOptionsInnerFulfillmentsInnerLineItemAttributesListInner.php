 ...
 * @email    jesse@highsidelabs.co
 */
class PromiseFulfillments200ResponsePayloadFulfillmentPlansInnerFulfillmentModulesInnerFulfillmentGroupsInnerFulfillmentOptionsInnerFulfillmentsInnerLineItemAttributesListInner extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'promiseFulfillments_200_response_payload_fulfillmentPlans_inner_fulfillmentModules_inner_fulfillmentGroups_inner_fulfillmentOptions_inner_fulfillments_inner_lineItemAttributesList_inner';
