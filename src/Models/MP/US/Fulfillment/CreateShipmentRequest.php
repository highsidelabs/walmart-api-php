 ...
 * @email    jesse@highsidelabs.co
 */
class CreateShipmentRequest extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'createShipment_request';
    ...
    public function setInboundOrderId($inboundOrderId)
    {
        ...
        if ((mb_strlen($inboundOrderId) > 100)) {
            throw new \InvalidArgumentException('invalid length for $inboundOrderId when calling CreateShipmentRequest., must be smaller than or equal to 100.');
        }
    ...
    public function setOrderItems($orderItems)
    {
        ...
        if ((count($orderItems) > 5000)) {
            throw new \InvalidArgumentException('invalid value for $orderItems when calling CreateShipmentRequest., number of items must be less than or equal to 5000.');
        }
        if ((count($orderItems) < 1)) {
            throw new \InvalidArgumentException('invalid length for $orderItems when calling CreateShipmentRequest., number of items must be greater than or equal to 1.');
        }
