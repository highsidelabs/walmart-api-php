 ...
 * @email    jesse@highsidelabs.co
 */
class InboundPreviewRequestHeader extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'inboundPreview_request_header';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['headerAttributes'] === null) {
            $invalidProperties[] = "'headerAttributes' can't be null";
        }
