 ...
 * @email    jesse@highsidelabs.co
 */
class AvailableQuantity extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AvailableQuantity';
    ...
    public function setMeasurementValue($measurementValue)
    {
        ...
        if (($measurementValue < 1)) {
            throw new \InvalidArgumentException('invalid value for $measurementValue when calling AvailableQuantity., must be bigger than or equal to 1.');
        }
