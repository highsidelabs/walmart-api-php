...
/**
 * CustomerOrderItemQuantityType Class Doc Comment
 *
 * @category Class
 ...
 * @email    jesse@highsidelabs.co
 */
class CustomerOrderItemQuantityType extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CustomerOrderItemQuantityType';
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['unitOfMeasure']) > 4)) {
            $invalidProperties[] = "invalid value for 'unitOfMeasure', the character length must be smaller than or equal to 4.";
        }
     ...
     * Sets unitOfMeasure
     *
     * @param string $unitOfMeasure Sales unit measure. Currently supported type : 'EACH'
     *
     * @return self
    ...
    public function setUnitOfMeasure($unitOfMeasure)
    {
        ...
        if ((mb_strlen($unitOfMeasure) > 4)) {
            throw new \InvalidArgumentException('invalid length for $unitOfMeasure when calling CustomerOrderItemQuantityType., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($unitOfMeasure) < 1)) {
            throw new \InvalidArgumentException('invalid length for $unitOfMeasure when calling CustomerOrderItemQuantityType., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param float $measurementValue Requested Quantity Information of an item
     *
     * @return self
    ...
    public function setMeasurementValue($measurementValue)
    {
        ...
        if (($measurementValue < 1)) {
            throw new \InvalidArgumentException('invalid value for $measurementValue when calling CustomerOrderItemQuantityType., must be bigger than or equal to 1.');
        }
