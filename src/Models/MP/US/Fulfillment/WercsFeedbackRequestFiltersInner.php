...
/**
 * WercsFeedbackRequestFiltersInner
 *
 * PHP version 7.4
 *
 * @category Class
 ...
 * @email    jesse@highsidelabs.co
 */
class WercsFeedbackRequestFiltersInner extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'wercsFeedback_request_filters_inner';
    ...
    public const VALUES_PROHIBITED = 'PROHIBITED';

    public const VALUES_IN_REVIEW = 'IN_REVIEW';

    public const VALUES_ACTION_NEEDED = 'ACTION_NEEDED';
    ...
    {
        return [
            self::VALUES_PROHIBITED,
            self::VALUES_IN_REVIEW,
            self::VALUES_ACTION_NEEDED,
        ];
    }
     ...
     * Sets field
     *
     * @param string|null $field | Attribute | Description | Data Type | --- | ----------- | ------- | status | Item status | string
     *
     * @return self
