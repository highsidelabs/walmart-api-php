...
/**
 * CancelFulfillmentRequestPayloadOrderItemsInnerQty
 *
 * PHP version 7.4
 *
 * @category Class
 ...
 * @email    jesse@highsidelabs.co
 */
class CancelFulfillmentRequestPayloadOrderItemsInnerQty extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'cancelFulfillment_request_payload_orderItems_inner_qty';
    ...
    public function setUnitOfMeasure($unitOfMeasure)
    {
        ...
        if ((mb_strlen($unitOfMeasure) > 32)) {
            throw new \InvalidArgumentException('invalid length for $unitOfMeasure when calling CancelFulfillmentRequestPayloadOrderItemsInnerQty., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($unitOfMeasure) < 1)) {
            throw new \InvalidArgumentException('invalid length for $unitOfMeasure when calling CancelFulfillmentRequestPayloadOrderItemsInnerQty., must be bigger than or equal to 1.');
        }
    ...
    public function setMeasurementValue($measurementValue)
    {
        ...
        if (($measurementValue < 1)) {
            throw new \InvalidArgumentException('invalid value for $measurementValue when calling CancelFulfillmentRequestPayloadOrderItemsInnerQty., must be bigger than or equal to 1.');
        }
