...
/**
 * CancelFulfillmentRequestPayloadOrderItemsInner
 *
 * PHP version 7.4
 *
 * @category Class
 ...
 * @email    jesse@highsidelabs.co
 */
class CancelFulfillmentRequestPayloadOrderItemsInner extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'cancelFulfillment_request_payload_orderItems_inner';
    ...
    public function setSellerLineId($sellerLineId)
    {
        ...
        if ((mb_strlen($sellerLineId) > 32)) {
            throw new \InvalidArgumentException('invalid length for $sellerLineId when calling CancelFulfillmentRequestPayloadOrderItemsInner., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($sellerLineId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sellerLineId when calling CancelFulfillmentRequestPayloadOrderItemsInner., must be bigger than or equal to 1.');
        }
