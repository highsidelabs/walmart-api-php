...
/**
 * CreateCarrierRateQuotesRequestLoadTypesInner
 *
 * PHP version 7.4
 *
 * @category Class
 ...
 * @email    jesse@highsidelabs.co
 */
class CreateCarrierRateQuotesRequestLoadTypesInner extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'createCarrierRateQuotes_request_loadTypes_inner';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['loadType'] === null) {
            $invalidProperties[] = "'loadType' can't be null";
        }
     ...
     * Sets loadType
     *
     * @param string $loadType loadType
     *
     * @return self
