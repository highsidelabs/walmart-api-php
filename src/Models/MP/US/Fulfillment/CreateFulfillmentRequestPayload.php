...
/**
 * CreateFulfillmentRequestPayload
 *
 * PHP version 7.4
 *
 * @category Class
 ...
 * @email    jesse@highsidelabs.co
 */
class CreateFulfillmentRequestPayload extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'createFulfillment_request_payload';
     ...
     * Sets orderChannelId
     *
     * @param string $orderChannelId Unique ID identifying channels from where the orders have been generated
     *
     * @return self
     ...
     * Sets sellerOrderId
     *
     * @param string $sellerOrderId Unique ID identifying customer order request
     *
     * @return self
    ...
    public function setSellerOrderId($sellerOrderId)
    {
        ...
        if ((mb_strlen($sellerOrderId) > 18)) {
            throw new \InvalidArgumentException('invalid length for $sellerOrderId when calling CreateFulfillmentRequestPayload., must be smaller than or equal to 18.');
        }
     ...
     *
     * @param \DateTime $orderPlacedTime Order placed time at respective channels
     *
     * @return self
     ...
     *
     * @param bool|null $needsConfirmation Flag to identify if confirmation is needed
     *
     * @return self
     ...
     *
     * @param bool|null $partialFulfillments Flag to identify if partial fulfilment is allowed
     *
     * @return self
