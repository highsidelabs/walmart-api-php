...
/**
 * CustomerOrderHeaderAttributes Class Doc Comment
 *
 * @category Class
 ...
 * @email    jesse@highsidelabs.co
 */
class CustomerOrderHeaderAttributes extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CustomerOrderHeaderAttributes';
