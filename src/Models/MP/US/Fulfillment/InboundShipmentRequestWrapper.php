...
/**
 * InboundShipmentRequestWrapper Class Doc Comment
 *
 * @category Class
 ...
 * @email    jesse@highsidelabs.co
 */
class InboundShipmentRequestWrapper extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'InboundShipmentRequestWrapper';
    ...
    protected static array $openAPITypes = [
        ...
        'inboundServices' => '\Walmart\Model\MP\US\Fulfillment\CreateShipmentRequestInboundServices',
    ...
    protected static array $setters = [
        ...
        'inboundServices' => 'setInboundServices',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('inboundServices', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['inboundOrderId']) > 100)) {
            $invalidProperties[] = "invalid value for 'inboundOrderId', the character length must be smaller than or equal to 100.";
        }
    ...
    public function setInboundOrderId($inboundOrderId)
    {
        ...
        if ((mb_strlen($inboundOrderId) > 100)) {
            throw new \InvalidArgumentException('invalid length for $inboundOrderId when calling InboundShipmentRequestWrapper., must be smaller than or equal to 100.');
        }
     ...
     *
     * @return \Walmart\Model\MP\US\Fulfillment\CreateShipmentRequestInboundServices|null
    
     */
    public function getInboundServices()
    {
        return $this->container['inboundServices'];
    }

    /**
     * Sets inboundServices
     *
     * @param \Walmart\Model\MP\US\Fulfillment\CreateShipmentRequestInboundServices|null $inboundServices inboundServices
     *
     * @return self
    ...
    {
        if (is_null($inboundServices)) {
            throw new \InvalidArgumentException('non-nullable inboundServices cannot be null');
        }

        $this->container['inboundServices'] = $inboundServices;
        return $this;
    }
    ...
    public function setOrderItems($orderItems)
    {
        ...
        if ((count($orderItems) > 5000)) {
            throw new \InvalidArgumentException('invalid value for $orderItems when calling InboundShipmentRequestWrapper., number of items must be less than or equal to 5000.');
        }
        if ((count($orderItems) < 1)) {
            throw new \InvalidArgumentException('invalid length for $orderItems when calling InboundShipmentRequestWrapper., number of items must be greater than or equal to 1.');
        }
