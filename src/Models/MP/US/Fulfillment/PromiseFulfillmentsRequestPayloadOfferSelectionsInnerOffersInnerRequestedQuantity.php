...
/**
 * PromiseFulfillmentsRequestPayloadOfferSelectionsInnerOffersInnerRequestedQuantity
 *
 * PHP version 7.4
 *
 * @category Class
 ...
 * @email    jesse@highsidelabs.co
 */
class PromiseFulfillmentsRequestPayloadOfferSelectionsInnerOffersInnerRequestedQuantity extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'promiseFulfillments_request_payload_offerSelections_inner_offers_inner_requestedQuantity';
    ...
    public function setMeasurementValue($measurementValue)
    {
        ...
        if (($measurementValue < 1)) {
            throw new \InvalidArgumentException('invalid value for $measurementValue when calling PromiseFulfillmentsRequestPayloadOfferSelectionsInnerOffersInnerRequestedQuantity., must be bigger than or equal to 1.');
        }
