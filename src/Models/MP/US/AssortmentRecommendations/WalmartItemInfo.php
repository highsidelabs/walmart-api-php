...
/**
 * WalmartItemInfo Class Doc Comment
 *
 * @category Class
 ...
 * @email    jesse@highsidelabs.co
 */
class WalmartItemInfo extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'WalmartItemInfo';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('wfsIndicator', $data ?? [], null);
     ...
     * Sets itemId
     *
     * @param string|null $itemId Walmart item id.
     *
     * @return self
     ...
     * Sets url
     *
     * @param string|null $url Walmart item url.
     *
     * @return self
     ...
     */
    public function getWfsIndicator()
    {
        return $this->container['wfsIndicator'];
    }

    /**
     * Sets wfsIndicator
     *
     * @param bool|null $wfsIndicator Walmart fulfilment service indicator.
     *
     * @return self
    
     */
    public function setWfsIndicator($wfsIndicator)
    {
        if (is_null($wfsIndicator)) {
            throw new \InvalidArgumentException('non-nullable wfsIndicator cannot be null');
        }

        $this->container['wfsIndicator'] = $wfsIndicator;
        return $this;
    }
