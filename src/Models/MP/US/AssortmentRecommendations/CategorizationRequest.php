...
/**
 * CategorizationRequest Class Doc Comment
 *
 * @category Class
 ...
 * @email    jesse@highsidelabs.co
 */
class CategorizationRequest extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CategorizationRequest';
    ...
    protected static array $openAPITypes = [
        ...
        'filterCriteria' => '\Walmart\Models\MP\US\AssortmentRecommendations\CategorizationRequestFilter'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['categorizationType'] === null) {
            $invalidProperties[] = "'categorizationType' can't be null";
        }
     ...
     *
     * @param string $categorizationType | Attribute | Description | Data Type | | --- | ----------- | ------- | | BRAND | To get list of brands which are associated with the assortment recommendations | string | | CATEGORY | To get list of categories which are associated with the assortment recommendations | string |
     *
     * @return self
     ...
     * Gets filterCriteria
     *
     * @return \Walmart\Models\MP\US\AssortmentRecommendations\CategorizationRequestFilter|null
     ...
     * Sets filterCriteria
     *
     * @param \Walmart\Models\MP\US\AssortmentRecommendations\CategorizationRequestFilter|null $filterCriteria filterCriteria
     *
     * @return self
