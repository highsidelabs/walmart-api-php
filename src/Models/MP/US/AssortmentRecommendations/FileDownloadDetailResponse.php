...
/**
 * FileDownloadDetailResponse Class Doc Comment
 *
 * @category Class
 ...
 * @email    jesse@highsidelabs.co
 */
class FileDownloadDetailResponse extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'FileDownloadDetailResponse';
     ...
     * Sets downloadURL
     *
     * @param string|null $downloadURL URL to be used to download the file.
     *
     * @return self
     ...
     *
     * @param string|null $downloadURLExpirationTime Time till when the URL to download the file will be valid.
     *
     * @return self
