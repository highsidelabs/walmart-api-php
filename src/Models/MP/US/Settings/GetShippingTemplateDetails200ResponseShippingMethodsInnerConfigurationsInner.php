 ...
 * @email    jesse@highsidelabs.co
 */
class GetShippingTemplateDetails200ResponseShippingMethodsInnerConfigurationsInner extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'getShippingTemplateDetails_200_response_shippingMethods_inner_configurations_inner';
