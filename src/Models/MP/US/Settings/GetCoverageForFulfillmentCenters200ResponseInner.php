...
/**
 * GetCoverageForFulfillmentCenters200ResponseInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetCoverageForFulfillmentCenters200ResponseInner Class Doc Comment
 *
 * @category Class
 ...
 * @email    jesse@highsidelabs.co
 */
class GetCoverageForFulfillmentCenters200ResponseInner extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'getCoverageForFulfillmentCenters_200_response_inner';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('coverageArea', $data ?? [], null);
    }
    ...
    {
        return $this->container['coverageArea'];
    }

    /**
     * Sets coverageArea
     *
     * @param string[]|null $coverageArea Two day shipping regions defined by Walmart for sellers.
     *
     * @return self
    ...
    {
        if (is_null($coverageArea)) {
            throw new \InvalidArgumentException('non-nullable coverageArea cannot be null');
        }

        $this->container['coverageArea'] = $coverageArea;
        return $this;
    }
}
