 ...
 * @email    jesse@highsidelabs.co
 */
class GetShippingTemplateDetails200ResponseShippingMethodsInnerConfigurationsInnerRegionsInnerSubRegionsInnerStatesInnerStateSubregionsInner extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'getShippingTemplateDetails_200_response_shippingMethods_inner_configurations_inner_regions_inner_subRegions_inner_states_inner_stateSubregions_inner';
