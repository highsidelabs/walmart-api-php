...
/**
 * UpdateShippingTemplatesRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * UpdateShippingTemplatesRequest Class Doc Comment
 *
 * @category Class
 ...
 * @email    jesse@highsidelabs.co
 */
class UpdateShippingTemplatesRequest extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'updateShippingTemplates_request';
    ...
    public function setName($name)
    {
        ...
        if ((!preg_match("/^[A-Za-z0-9\\s]+$/", $name))) {
            throw new \InvalidArgumentException("invalid value for \$name when calling UpdateShippingTemplatesRequest., must conform to the pattern /^[A-Za-z0-9\\s]+$/.");
        }
     ...
     *
     * @return \Walmart\Model\MP\US\Settings\GetShippingTemplateDetails200ResponseShippingMethodsInner[]
     ...
     *
     * @param \Walmart\Model\MP\US\Settings\GetShippingTemplateDetails200ResponseShippingMethodsInner[] $shippingMethods Array of different ship methods of a Shipping Template
     *
     * @return self
