...
/**
 * UpdateShippingAreaToRuleRequestRules
 *
 * PHP version 7.4
 *
 * @category Class
 ...
 * @email    jesse@highsidelabs.co
 */
class UpdateShippingAreaToRuleRequestRules extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'updateShippingAreaToRule_request_rules';
    ...
    protected static array $openAPITypes = [
        'ruleId' => 'string',
        'ruleStatus' => 'string',
        'actions' => '\Walmart\Model\MP\US\Rules\UpdateShippingAreaToRuleRequestRulesActionsInner[]'
    ];
     ...
     * Sets actions
     *
     * @param \Walmart\Model\MP\US\Rules\UpdateShippingAreaToRuleRequestRulesActionsInner[]|null $actions Defines the two day state coverage areas.
     *
     * @return self
