...
/**
 * UpdateShippingAreaToRuleRequestRulesActionsInnerTwoDayShippingRegionsInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * UpdateShippingAreaToRuleRequestRulesActionsInnerTwoDayShippingRegionsInner Class Doc Comment
 *
 * @category Class
 ...
 * @email    jesse@highsidelabs.co
 */
class UpdateShippingAreaToRuleRequestRulesActionsInnerTwoDayShippingRegionsInner extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'updateShippingAreaToRule_request_rules_actions_inner_twoDayShippingRegions_inner';
