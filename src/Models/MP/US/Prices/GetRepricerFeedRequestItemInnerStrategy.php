...
/**
 * GetRepricerFeedRequestItemInnerStrategy Class Doc Comment
 *
 * @category Class
 ...
 * @email    jesse@highsidelabs.co
 */
class GetRepricerFeedRequestItemInnerStrategy extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'getRepricerFeed_request_Item_inner_Strategy';
