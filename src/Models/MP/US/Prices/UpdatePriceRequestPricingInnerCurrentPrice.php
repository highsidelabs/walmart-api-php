 ...
 * @email    jesse@highsidelabs.co
 */
class UpdatePriceRequestPricingInnerCurrentPrice extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'updatePrice_request_pricing_inner_currentPrice';
