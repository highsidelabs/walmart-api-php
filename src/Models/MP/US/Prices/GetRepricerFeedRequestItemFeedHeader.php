...
/**
 * GetRepricerFeedRequestItemFeedHeader Class Doc Comment
 *
 * @category Class
 ...
 * @email    jesse@highsidelabs.co
 */
class GetRepricerFeedRequestItemFeedHeader extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'getRepricerFeed_request_ItemFeedHeader';
