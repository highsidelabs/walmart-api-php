...
/**
 * CancelOrderLinesCARequestOrderLinesOrderLineInnerOrderLineStatusesOrderLineStatusInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * CancelOrderLinesCARequestOrderLinesOrderLineInnerOrderLineStatusesOrderLineStatusInner Class Doc Comment
 *
 * @category Class
 ...
 * @email    jesse@highsidelabs.co
 */
class CancelOrderLinesCARequestOrderLinesOrderLineInnerOrderLineStatusesOrderLineStatusInner extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'cancelOrderLinesCA_request_orderLines_orderLine_inner_orderLineStatuses_orderLineStatus_inner';
    ...
    public const CANCELLATION_REASON_CANCEL_BY_SELLER = 'CANCEL_BY_SELLER';

    public const CANCELLATION_REASON_CUSTOMER_REQUESTED_SELLER_TO_CANCEL = 'CUSTOMER_REQUESTED_SELLER_TO_CANCEL';

    public const CANCELLATION_REASON_SUPPLIER_CANCEL = 'SUPPLIER_CANCEL';

    public const CANCELLATION_REASON_SUPPLIER_CANCEL_CUSTOMER_REQUEST = 'SUPPLIER_CANCEL_CUSTOMER_REQUEST';

    public const CANCELLATION_REASON_SUPPLIER_CANCEL_BACKORDER = 'SUPPLIER_CANCEL_BACKORDER';

    public const CANCELLATION_REASON_SUPPLIER_CANCEL_DISCONTINUE = 'SUPPLIER_CANCEL_DISCONTINUE';

    public const CANCELLATION_REASON_SUPPLIER_CANCEL_UNRECOGNIZED = 'SUPPLIER_CANCEL_UNRECOGNIZED';
    ...
    {
        return [
            self::CANCELLATION_REASON_CANCEL_BY_SELLER,
            self::CANCELLATION_REASON_CUSTOMER_REQUESTED_SELLER_TO_CANCEL,
            self::CANCELLATION_REASON_SUPPLIER_CANCEL,
            self::CANCELLATION_REASON_SUPPLIER_CANCEL_CUSTOMER_REQUEST,
            self::CANCELLATION_REASON_SUPPLIER_CANCEL_BACKORDER,
            self::CANCELLATION_REASON_SUPPLIER_CANCEL_DISCONTINUE,
            self::CANCELLATION_REASON_SUPPLIER_CANCEL_UNRECOGNIZED,
        ];
    }
     ...
     *
     * @param string $cancellationReason Reason for cancellation. Example: 'CUSTOMER_REQUESTED_SELLER_TO_CANCEL'
     *
     * @return self
