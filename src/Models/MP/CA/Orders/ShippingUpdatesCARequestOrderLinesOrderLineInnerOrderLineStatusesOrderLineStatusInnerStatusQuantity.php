...
/**
 * ShippingUpdatesCARequestOrderLinesOrderLineInnerOrderLineStatusesOrderLineStatusInnerStatusQuantity
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ShippingUpdatesCARequestOrderLinesOrderLineInnerOrderLineStatusesOrderLineStatusInnerStatusQuantity Class Doc Comment
 *
 * @category Class
 ...
 * @email    jesse@highsidelabs.co
 */
class ShippingUpdatesCARequestOrderLinesOrderLineInnerOrderLineStatusesOrderLineStatusInnerStatusQuantity extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'shippingUpdatesCA_request_orderLines_orderLine_inner_orderLineStatuses_orderLineStatus_inner_statusQuantity';
     ...
     *
     * @param string $unitOfMeasurement Always use 'EACH'
     *
     * @return self
