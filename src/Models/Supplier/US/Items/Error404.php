...
class Error404 extends BaseModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Error404';
     ...
     * Sets code
     *
     * @param string|null $code Error code of the response.   Example: CONTENT_NOT_FOUND.GMP_ITEM_QUERY_API
     *
     * @return self
     ...
     * Sets description
     *
     * @param string|null $description Description of error.  Example: Item does not exist in Walmart's catalog
     *
     * @return self
     ...
     * Sets info
     *
     * @param string|null $info Info of error.  Example: Requested content could not be found.
     *
     * @return self
     ...
     * Sets severity
     *
     * @param string|null $severity Severity of Error.  Example: INFO
     *
     * @return self
     ...
     * Sets category
     *
     * @param string|null $category Category of error.  Example: APPLICATION
     *
     * @return self
