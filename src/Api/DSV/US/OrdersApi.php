...
class OrdersApi extends BaseApi
{
     ...
     * @return \Walmart\Model\DSV\US\Orders\ShipOrderLines200Response
     */
    public function acknowledgeOrders(
        string $purchaseOrderId,
        string $shipNode
    ): \Walmart\Model\DSV\US\Orders\ShipOrderLines200Response {
    ...
    protected function acknowledgeOrdersWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Model\DSV\US\Orders\ShipOrderLines200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Model\DSV\US\Orders\ShipOrderLines200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Model\DSV\US\Orders\ShipOrderLines200Response', $response->getHeaders());
            }

            $returnType = '\Walmart\Model\DSV\US\Orders\ShipOrderLines200Response';
     ...
     * @param  string $shipNode The Distribution Facility “Distributor ID” which uniquely identifies each facility and is autogenerated during DSV account creation. Every time you add/update a facility in the Supplier Center, a new ID is generated (required)
     * @param  \Walmart\Model\DSV\US\Orders\CancelOrderLinesRequest $cancelOrderLinesRequest File fields (required)
     *
     * @throws \Walmart\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Walmart\Model\DSV\US\Orders\ShipOrderLines200Response
    ...
    public function cancelOrderLines(
        string $purchaseOrderId,
        string $shipNode,
        \Walmart\Model\DSV\US\Orders\CancelOrderLinesRequest $cancelOrderLinesRequest
    ): \Walmart\Model\DSV\US\Orders\ShipOrderLines200Response {
     ...
     * @throws \Walmart\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Walmart\Model\DSV\US\Orders\GetAllOrders200Response
     */
    ...
    ): \Walmart\Model\DSV\US\Orders\GetAllOrders200Response {
    ...
    protected function getAllOrdersWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Model\DSV\US\Orders\GetAllOrders200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Model\DSV\US\Orders\GetAllOrders200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Model\DSV\US\Orders\GetAllOrders200Response', $response->getHeaders());
            }

            $returnType = '\Walmart\Model\DSV\US\Orders\GetAllOrders200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @param  string $purchaseOrderId A unique ID associated with the purchase order, used for querying (required)
     * @param  string $shipNode The Distribution Facility “Distributor ID” which uniquely identifies each facility and is autogenerated during DSV account creation. Every time you add/update a facility in the Supplier Center, a new ID is generated (required)
     * @param  \Walmart\Model\DSV\US\Orders\ShipOrderLinesRequest $shipOrderLinesRequest File fields (required)
     *
     * @throws \Walmart\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Walmart\Model\DSV\US\Orders\ShipOrderLines200Response
    ...
    public function shipOrderLines(
        string $purchaseOrderId,
        string $shipNode,
        \Walmart\Model\DSV\US\Orders\ShipOrderLinesRequest $shipOrderLinesRequest
    ): \Walmart\Model\DSV\US\Orders\ShipOrderLines200Response {
