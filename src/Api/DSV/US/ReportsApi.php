...
class ReportsApi extends BaseApi
{
     ...
     * @return \Walmart\Model\DSV\US\Reports\GetItemReport200Response
     */
    public function getItemReport(
        string $type,
        string $version
    ): \Walmart\Model\DSV\US\Reports\GetItemReport200Response {
    ...
    protected function getItemReportWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Model\DSV\US\Reports\GetItemReport200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Model\DSV\US\Reports\GetItemReport200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Model\DSV\US\Reports\GetItemReport200Response', $response->getHeaders());
            }

            $returnType = '\Walmart\Model\DSV\US\Reports\GetItemReport200Response';
