...
```php
getAllFeedStatuses($feedId, $offset, $limit): \Walmart\Model\DSV\US\Feeds\GetAllFeedStatuses200Response
```
Feed status
...
[**\Walmart\Model\DSV\US\Feeds\GetAllFeedStatuses200Response**](../Model/GetAllFeedStatuses200Response.md)
...
```php
getFeedItemStatus($feedId, $includeDetails, $offset, $limit): \Walmart\Model\DSV\US\Feeds\GetFeedItemStatus200Response
```
Feed item status
...
[**\Walmart\Model\DSV\US\Feeds\GetFeedItemStatus200Response**](../Model/GetFeedItemStatus200Response.md)
