...
[**\Walmart\Models\DSV\US\Orders\ShipOrderLines200Response**](../../../Models/DSV/US/orders/ShipOrderLines200Response.md)
...
try {
    $result = $api->cancelOrderLines($purchaseOrderId, $shipNode, $cancelOrderLinesRequest);
    print_r($result);
} catch (Exception $e) {
...
| **shipNode** | **string**| The Distribution Facility “Distributor ID” which uniquely identifies each facility and is autogenerated during DSV account creation. Every time you add/update a facility in the Supplier Center, a new ID is generated | |
| **cancelOrderLinesRequest** | [**\Walmart\Models\DSV\US\Orders\CancelOrderLinesRequest**](../../../Models/DSV/US/orders/CancelOrderLinesRequest.md)| File fields | |
...
try {
    $result = $api->shipOrderLines($purchaseOrderId, $shipNode, $shipOrderLinesRequest);
    print_r($result);
} catch (Exception $e) {
...
| **purchaseOrderId** | **string**| A unique ID associated with the purchase order, used for querying | |
| **shipNode** | **string**| The Distribution Facility “Distributor ID” which uniquely identifies each facility and is autogenerated during DSV account creation. Every time you add/update a facility in the Supplier Center, a new ID is generated | |
| **shipOrderLinesRequest** | [**\Walmart\Models\DSV\US\Orders\ShipOrderLinesRequest**](../../../Models/DSV/US/orders/ShipOrderLinesRequest.md)| File fields | |
