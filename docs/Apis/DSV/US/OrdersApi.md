...
```php
acknowledgeOrders($purchaseOrderId, $shipNode): \Walmart\Model\DSV\US\Orders\ShipOrderLines200Response
```
Acknowledge Orders
...
[**\Walmart\Model\DSV\US\Orders\ShipOrderLines200Response**](../Model/ShipOrderLines200Response.md)
...
```php
cancelOrderLines($purchaseOrderId, $shipNode, $cancelOrderLinesRequest): \Walmart\Model\DSV\US\Orders\ShipOrderLines200Response
```
Cancel order lines
...
$shipNode = 'shipNode_example'; // string | The Distribution Facility “Distributor ID” which uniquely identifies each facility and is autogenerated during DSV account creation. Every time you add/update a facility in the Supplier Center, a new ID is generated
$cancelOrderLinesRequest = {"orderCancellation":{"orderLines":{"orderLine":[{"lineNumber":"1","orderLineStatuses":{"orderLineStatus":[{"status":"Cancelled","cancellationReason":"SUPPLIER_CANCEL_UNRECOGNIZED","statusQuantity":{"unitOfMeasurement":"EACH","amount":"1"}}]}}]}}}; // \Walmart\Model\DSV\US\Orders\CancelOrderLinesRequest | File fields
...
| **shipNode** | **string**| The Distribution Facility “Distributor ID” which uniquely identifies each facility and is autogenerated during DSV account creation. Every time you add/update a facility in the Supplier Center, a new ID is generated | |
| **cancelOrderLinesRequest** | [**\Walmart\Model\DSV\US\Orders\CancelOrderLinesRequest**](../Model/CancelOrderLinesRequest.md)| File fields | |
...
```php
getAllOrders($shipNode, $limit, $sku, $customerOrderId, $purchaseOrderId, $status, $createdStartDate, $createdEndDate, $fromExpectedShipDate, $toExpectedShipDate, $productInfo): \Walmart\Model\DSV\US\Orders\GetAllOrders200Response
```
All orders
...
[**\Walmart\Model\DSV\US\Orders\GetAllOrders200Response**](../Model/GetAllOrders200Response.md)
...
```php
getAllReleasedOrders($shipNode, $sku, $customerOrderId, $purchaseOrderId, $createdStartDate, $createdEndDate, $fromExpectedShipDate, $toExpectedShipDate, $limit, $productInfo): \Walmart\Model\DSV\US\Orders\GetAllOrders200Response
```
All released orders
...
```php
getAnOrder($purchaseOrderId, $shipNode, $productInfo): \Walmart\Model\DSV\US\Orders\ShipOrderLines200Response
```
An order
...
```php
shipOrderLines($purchaseOrderId, $shipNode, $shipOrderLinesRequest): \Walmart\Model\DSV\US\Orders\ShipOrderLines200Response
```
Ship order lines
...
| **purchaseOrderId** | **string**| A unique ID associated with the purchase order, used for querying | |
| **shipNode** | **string**| The Distribution Facility “Distributor ID” which uniquely identifies each facility and is autogenerated during DSV account creation. Every time you add/update a facility in the Supplier Center, a new ID is generated | |
| **shipOrderLinesRequest** | [**\Walmart\Model\DSV\US\Orders\ShipOrderLinesRequest**](../Model/ShipOrderLinesRequest.md)| File fields | |
