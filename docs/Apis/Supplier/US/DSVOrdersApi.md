...
```php
acknowledgeOrders($purchaseOrderId, $shipNode, $accept, $wMPARTNERID): \Walmart\Models\Supplier\US\DSVOrders\GetOrderResponseRecord
```
Acknowledge Orders
...
try {
    $result = $api->acknowledgeOrders($purchaseOrderId, $shipNode, $accept, $wMPARTNERID);
    print_r($result);
} catch (Exception $e) {
...
```php
cancelOrderLines($purchaseOrderId, $shipNode, $accept, $wMPARTNERID, $orderCancellation): \Walmart\Models\Supplier\US\DSVOrders\GetOrderResponseRecord
```
Cancel order lines
...
try {
    $result = $api->cancelOrderLines($purchaseOrderId, $shipNode, $accept, $wMPARTNERID, $orderCancellation);
    print_r($result);
} catch (Exception $e) {
...
```php
getAllOrders($shipNode, $accept, $wMPARTNERID, $limit, $sku, $customerOrderId, $purchaseOrderId, $status, $createdStartDate, $createdEndDate, $fromExpectedShipDate, $toExpectedShipDate, $productInfo): \Walmart\Models\Supplier\US\DSVOrders\OrdersListType
```
All orders
...
try {
    $result = $api->getAllOrders($shipNode, $accept, $wMPARTNERID, $limit, $sku, $customerOrderId, $purchaseOrderId, $status, $createdStartDate, $createdEndDate, $fromExpectedShipDate, $toExpectedShipDate, $productInfo);
    print_r($result);
} catch (Exception $e) {
...
```php
getAllReleasedOrders($shipNode, $accept, $wMPARTNERID, $sku, $customerOrderId, $purchaseOrderId, $createdStartDate, $createdEndDate, $fromExpectedShipDate, $toExpectedShipDate, $limit, $productInfo): \Walmart\Models\Supplier\US\DSVOrders\OrdersListType
```
All released orders
...
try {
    $result = $api->getAllReleasedOrders($shipNode, $accept, $wMPARTNERID, $sku, $customerOrderId, $purchaseOrderId, $createdStartDate, $createdEndDate, $fromExpectedShipDate, $toExpectedShipDate, $limit, $productInfo);
    print_r($result);
} catch (Exception $e) {
...
```php
getAnOrder($purchaseOrderId, $shipNode, $accept, $wMPARTNERID, $productInfo): \Walmart\Models\Supplier\US\DSVOrders\GetOrderResponseRecord
```
An order
...
try {
    $result = $api->getAnOrder($purchaseOrderId, $shipNode, $accept, $wMPARTNERID, $productInfo);
    print_r($result);
} catch (Exception $e) {
...
```php
shipOrderLines($purchaseOrderId, $shipNode, $accept, $wMPARTNERID, $orderCancellation): \Walmart\Models\Supplier\US\DSVOrders\GetOrderResponseRecord
```
Ship order lines
...
try {
    $result = $api->shipOrderLines($purchaseOrderId, $shipNode, $accept, $wMPARTNERID, $orderCancellation);
    print_r($result);
} catch (Exception $e) {
