...
```php
getInventoryForAnItem($gtin, $shipNode, $accept, $wMPARTNERID, $sku): \Walmart\Models\Supplier\US\DSVInventory\InventoryResponse
```
Inventory
...
try {
    $result = $api->getInventoryForAnItem($gtin, $shipNode, $accept, $wMPARTNERID, $sku);
    print_r($result);
} catch (Exception $e) {
...
```php
getMultiNodeInventoryForSkuAndAllShipnodes($id, $productIdType, $accept, $wMPARTNERID, $shipNode): \Walmart\Models\Supplier\US\DSVInventory\InventoriesDTO
```
...
try {
    $result = $api->getMultiNodeInventoryForSkuAndAllShipnodes($id, $productIdType, $accept, $wMPARTNERID, $shipNode);
    print_r($result);
} catch (Exception $e) {
...
```php
updateBulkInventory($feedType, $accept, $wMPARTNERID, $inventoryFeedV2, $shipNode): \Walmart\Models\Supplier\US\DSVInventory\FeedIdInventory
```
...
try {
    $result = $api->updateBulkInventory($feedType, $accept, $wMPARTNERID, $inventoryFeedV2, $shipNode);
    print_r($result);
} catch (Exception $e) {
...
```php
updateInventoryForAnItem($shipNode, $accept, $wMPARTNERID, $inventory): \Walmart\Models\Supplier\US\DSVInventory\InventoryResponse
```
Update Inventory
...
try {
    $result = $api->updateInventoryForAnItem($shipNode, $accept, $wMPARTNERID, $inventory);
    print_r($result);
} catch (Exception $e) {
