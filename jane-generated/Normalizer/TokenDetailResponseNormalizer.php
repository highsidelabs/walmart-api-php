...
class TokenDetailResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Walmart\\Model\\TokenDetailResponse';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Walmart\\Model\\TokenDetailResponse';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Walmart\Model\TokenDetailResponse();
        ...
        if (\array_key_exists('scopes', $data)) {
            $object->setScopes($this->denormalizer->denormalize($data['scopes'], 'Walmart\\Model\\TokenDetailResponseScopes', 'json', $context));
            unset($data['scopes']);
        }
